...
After all packages are installed, run FlaskApp.py, and type “npm run dev” in a new terminal. After this, click on the localhost link that appears in the terminal that is running the ‘npm run dev’ command.

**Guide:**

_Exam Upload:_  
1. Upload an exam (either a .pdf or .txt format).  
